...
## Run intermediator application
echo "-- Start intermediator application"
intermediator_cmd="mpirun -np $NINTERMEDIATORS ./intermediator dataspaces 2 1 2 2 ./forward.py direct $NSTEPS"
echo ${intermediator_cmd}
eval ${intermediator_cmd} &> log.intermediator &
intermediator_pid=$!

## Run consumer application
echo "-- Start consumer application"
consumer_cmd="mpirun -n $NREADERS ./consumer dataspaces 3 2 ./compute.py analyze $NSTEPS"
echo ${consumer_cmd}
