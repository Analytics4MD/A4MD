...
def get_parameters():
    ...
    parameters["data_dump_interval"] = [100,200]#[10,100,160,200,250,400,500,800,1000]#[1, 10, 20, 100]#, 5000, 10000]#, 100, 500, 1000, 5000, 10000]#[10, 50, 100, 500, 1000, 5000]#, 10000, 20000]
