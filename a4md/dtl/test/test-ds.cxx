...
void ds_write_and_read()
{
    ...
    dataspaces_writer_ptr = new DataSpacesWriter(1, 1, temp_var_name, total_chunks, MPI_COMM_WORLD);
    dataspaces_reader_ptr = new DataSpacesReader(2, 1, temp_var_name, total_chunks, MPI_COMM_WORLD);
